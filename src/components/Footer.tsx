        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:hello@casecrate.com" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                <Mail size={24} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link to="/shop" className="block text-gray-300 dark:text-gray-400 hover:text-white transition-colors">Shop</Link>
              <Link to="/order" className="block text-gray-300 dark:text-gray-400 hover:text-white transition-colors">Bulk Orders</Link>
              <Link to="/about" className="block text-gray-300 dark:text-gray-400 hover:text-white transition-colors">About Us</Link>
              <Link to="/contact" className="block text-gray-300 dark:text-gray-400 hover:text-white transition-colors">Contact</Link>
            </div>
          </div>
